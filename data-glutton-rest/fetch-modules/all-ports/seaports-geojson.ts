...
function parseData(seaportData: SeaportGeoFeature[], totalItems: number): void {
	let lastPercentageEmitted = 0;
	Object.values(seaportData).forEach((sp: SeaportGeoFeature, index: number) => {
